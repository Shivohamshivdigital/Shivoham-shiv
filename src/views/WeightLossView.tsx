            ...
            {isSuccess ? (
              <div className="p-8 bg-[#E3F1E3] border border-green-200 text-[#2F5233] rounded-2xl text-center space-y-3">
                ...
                <p className="text-xs leading-relaxed max-w-md mx-auto">
                  Pranama! We have logged your weight-loss diagnostic request. We are now redirecting you to converse with our lead counselor directly on WhatsApp (+91 73177 78215) for your timeslot confirmation.
                </p>
                <a
                  href="https://wa.me/917317778215"
                  target="_blank"
