...
export interface Course {
  ...
  title: string;
  tagline: string;
  category: "Corporate & Adult Wellness" | "Kids EQ" | "Meditation" | "Mudra Therapy" | "Ayurvedic Acupressure";
  description: string;
  rating: number;
  reviewsCount: number;
  duration: string;
  ...
  schedule?: string;
  // Optional alternate / regional name, e.g. "Ayurvedic Acupressure" for Acupressure.
  altName?: string;
}
